    ...
    <div>
      ...
      >
        ...
        <div className="flex flex-row gap-7 mt-8">
          <CTAButton active={true} path={"/login"}>
            Learn More
          </CTAButton>
          <CTAButton active={false} path={"/signup"}>
            Book a Demo
          </CTAButton>
        </div>
        ...
        <div>
          ...
          <CodeBlocks
            ...
            subheading={`Our courses are designed and taught  by industry experts who have years
      ...
      <div className="w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-richblack-900 text-white">
        ...
        <h2 className="text-center text-3xl font-semobold mt-10">
